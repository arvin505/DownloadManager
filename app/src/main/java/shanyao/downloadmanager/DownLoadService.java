...
public class DownLoadService extends Service {
    ...
    String url = "http://www.sycy888.com/app/file/";

    String fileName = "1041EC94da.zip";

    private String destFileName = "1041EC94da.zip";
        ...
        retrofit.baseUrl(url)
                ...
                .enqueue(new FileCallback(destFileDir, destFileName) {
                    ...
                    public void onSuccess(File file) {
                        ...
                        // 安装软件
//                        cancelNotification();
                        Unzip(destFileDir+"/"+fileName,destFileDir+"/bbbbb/");
                    }
...
//                        updateNotification(progress * 100 / total);
                        MainActivity.updateProgress(progress,total);
                    }
